...
{
	n=request.getParameter("to");
}
%>
		<div id="navbar" class="navbar">
			<ul>
				<li><a class="navlinkactive" href="compose.jsp" >Compose</a></li>
		...
		<div id="form" style="padding:40px">
			<h1 class="form_heading" align="center"> Compose a mail </h1>
...
{
%>
								<input type="text" size="12" maxlength="10" name="rnum" value=" <%= n%> " disabled>
<%
}
%>
							</td>
						...
						<tr>
							<td> Subject </td>
							<td> :   </td>
							<td><input  type="text" size="50" name="sub" placeholder="No subject" \></td>
						</tr>
						<tr>
							<td> Message </td>
							<td> :   </td>
							<td><textarea row="25" col="100" name="msg"></textarea></td>
						</tr>					
					</table>
					<center>
						<input type="submit" class="formbtn" value="Send"/>
						<input type="submit" class="formbtn" formaction="savedraft.jsp" value="Save as Draft"/>
					</center>
				</form>
		</div>
<%
