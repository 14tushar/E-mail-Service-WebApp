	...
	<body>
		<div id="navbar" class="navbar">
			<ul>
				...
				<li><a class="navlinkactive" href="draft.jsp">Draft</a></li>
		...
		<div id="form" style="padding:40px">
			<h1 class="form_heading" align="center"> Draft Messages </h1>
...
<%
	try
	{
		...
		{	
%>
				<a href="message.jsp?draft=<%= rs1.getString(6) %>" class="email_link">
