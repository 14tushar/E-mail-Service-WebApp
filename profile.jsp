...
%>		
		...
		<div id="form" style="padding:40px">
			<h1 class="form_heading" align="center"> Profile </h1>
...
<%
	try
	{
		...
		ResultSet rs1=s1.executeQuery("select * from users where mobilenum="+snum);	
		rs1.next();
%>
					<center>
						<img src="<%= snum %>.jpg" style="width:20%;margin:auto;">
					</center>
