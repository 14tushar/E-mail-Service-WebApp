	...
	<body>
		<div id="navbar" class="navbar">
			<ul>
				...
				<li><a class="navlinkactive" href="sentmails.jsp">Sentbox</a></li>
		...
		<div id="form" style="padding:40px">
			<h1 class="form_heading" align="center"> Sent Messages </h1>
...
<%
	try
	{
		...
		ResultSet rs1=s1.executeQuery("select * from mails where sendernum="+snum+" and receivernum!=1 order by time desc");	
		while(rs1.next())
		{	
%>
				<a href="message.jsp?sent=<%= rs1.getString(6) %>" class="email_link">
